...
export const AuthProvider = ({ children }) => {
  ...
  const logout = () => {
    ...
    // Clear all persistent user data from localStorage
    localStorage.removeItem('eduarena_total_points');
    localStorage.removeItem('javaGameProgress');
    localStorage.removeItem('edurena_progress');
