...
const Profile = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { role: "assistant", content: "Hello! I'm your Aptitude Prep assistant. How can I help you today?" }
  ])
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setChatMessages(prev => [
        ...
        { 
          role: "assistant", 
          content: "I'm processing your question about Aptitude Prep. Here's a helpful response..." 
        }
      ])
    }, 1000)
  ...
  const javaCourse = {
    ...
    icon: "📈",
    modules: [
      { name: "Speed Math & Simplification", progress: 100, completed: true },
      { name: "Number System", progress: 100, completed: true },
      { name: "Percentages & Ratios", progress: 80, completed: false },
      { name: "Profit & Loss", progress: 40, completed: false },
      { name: "Time, Speed & Distance", progress: 0, completed: false },
      { name: "Time & Work", progress: 0, completed: false },
      { name: "Permutations & Combinations", progress: 0, completed: false },
  ...
  const achievements = [
    ...
    },
    {
      ...
      status: "In Progress",
      description: "Complete all Aptitude modules",
      progress: 65
    },
    {
      name: "Math Wizard",
      ...
      status: "Locked",
      description: "Complete 50 quant challenges",
      progress: 30
    },
    {
      name: "Problem Solver",
  ...
  const learningStats = {
    ...
    quizzesTaken: 12,
    averageScore: 85,
    nextMilestone: "Complete Percentages module"
  }
          ...
          <TabsContent value="courses" className="space-y-6">
            <Card className="backdrop-blur-sm bg-white/10 border-none shadow-xl">
              <CardHeader>
                ...
                <CardDescription className="text-purple-200">
                  Master math and formulas from basics to advanced shortcuts
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <CardContent>
                  {isChatOpen ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-[400px] text-center p-4">
                      ...
                      <h3 className="text-white font-medium mb-2">Need help with Aptitude?</h3>
                      <p className="text-purple-200 text-sm mb-4">
                        Ask questions, get formula shortcuts, or plan your placement journey with our AI assistant.
                      </p>
                      <Button 
